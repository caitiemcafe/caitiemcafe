...
useHead({
  title: 'Quản trị Cái Tiệm KÀFE',
  link: [
    { rel: 'manifest', href: '/admin-manifest.json', key: 'pwa-manifest' }
  ]
})
  ...
  <div class="admin-shell">
    ...
    <main class="admin-main">
      <header>
        ...
        <button v-if="isInstallable" class="admin-pwa-btn" @click="install">
          <Download :size="16" /> Tải App Manager
        </button>
...
.admin-pwa-btn { margin-left: auto; display: inline-flex; align-items: center; gap: 6px; padding: 8px 14px; border: 1px solid rgba(135, 74, 39, 0.3); border-radius: 10px; background: rgba(135, 74, 39, 0.08); color: #874a27; font-weight: 700; font-size: 0.82rem; cursor: pointer; transition: 0.2s; }
.admin-pwa-btn:hover { background: rgba(135, 74, 39, 0.16); }
</style>
