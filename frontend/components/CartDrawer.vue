    ...
    <aside class="drawer" aria-label="Giỏ hàng">
      ...
      <template v-if="step === 'cart'">
        ...
        <div v-else class="cart-content">
          ...
          <div class="summary">
            ...
            <button class="btn btn-primary" @click="step = 'checkout'">Tiếp tục đặt hàng</button>
          </div>
        </div>
      </template>
      ...
      <form v-else-if="step === 'checkout'" class="checkout" @submit.prevent="submit">
        ...
        <div class="checkout-actions">
          ...
          <button class="btn btn-primary" :disabled="loading"><span v-if="loading" class="spinner"></span>{{ loading ? 'Đang gửi đơn...' : `Đặt hàng · ${money(total)}` }}</button>
        </div>
      </form>
      ...
      <div v-else class="success">
        ...
        <h3 class="serif">Cảm ơn bạn đã ghé Cái Tiệm!</h3>
