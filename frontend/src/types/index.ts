...
export interface Settings { shipping_fee?: string; shop_name?: string; shop_phone?: string; shop_address?: string; shop_email?: string; shop_opening_hours?: string; is_accepting_orders?: string; ai_provider?: string; ai_api_key?: string; ai_proxy_url?: string; ai_model?: string }
