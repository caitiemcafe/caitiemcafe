...
<template>
  <header class="site-header">
    <div class="container nav-wrap">
      <RouterLink to="/" class="brand" aria-label="Cái Tiệm - Trang chủ"><img src="/images/brand/cafe-name.png" alt="Cái Tiệm" /></RouterLink>
...
.cart-button,.menu-button { position: relative; width: 44px; height: 44px; display: grid; place-items: center; color: white; border: 1px solid rgba(255,255,255,.22); border-radius: 50%; background: rgba(25,15,10,.25); backdrop-filter: blur(12px); }
